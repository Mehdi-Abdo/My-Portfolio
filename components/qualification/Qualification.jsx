          ...
          >
            ...
            <motion.div className="qualification__data" variants={dataVariants}>
              <div>
                ...
                <span className="qualification__subtitle">Ahmed elhansali- Sale</span>
            ...
            <motion.div className="qualification__data" variants={dataVariants}>
              ...
              <div>
                ...
                <span className="qualification__subtitle">Alx Africa Casablanca</span>
                <div className="qualification__calender">
                  <i className="uil uil-calendar-alt"></i> 24-01-2025
                </div>
              </div>
            </motion.div>
          </motion.div>
