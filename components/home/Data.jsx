...
const Data = () => {
  ...
  const originalText = "Mehdi Abdellaoui ";
  ...
  return (
    <div className="home__data">
      ...
      <p className="home__description">I'm a Front-End developer based in Morocco, and I'm passionate about crafting clean, responsive, and user-friendly web experiences.</p>

      <a href="https://cal.com/mehdi-abdelaoui-mb2jz4" className="button button--flex">
        Say Hello
        <svg
